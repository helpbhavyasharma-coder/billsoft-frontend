...
import { FileText, Eye, EyeOff, LockKeyhole, ShieldCheck, ExternalLink, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, var(--bg) 0%, var(--bg-card) 100%)' }}>
      <div className="w-full max-w-5xl">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <div className="card">
            <div className="mb-5 flex items-start gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl" style={{ background: 'rgba(100,116,139,0.15)', color: 'var(--text-2)' }}>
                <LockKeyhole className="h-5 w-5" />
              </div>
              <div>
                <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>Old BillSoft Login</h2>
                <p className="text-sm mt-1" style={{ color: 'var(--text-3)' }}>Existing accounts ke liye fallback. Successful login par Bhauu Auth se link ki koshish hogi.</p>
              </div>
            </div>
